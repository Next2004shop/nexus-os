...
export const AIChat = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 w-full h-[100dvh] bg-[#181a20] flex flex-col z-[9999] animate-slide-up md:inset-auto md:bottom-24 md:right-6 md:w-96 md:h-[500px] md:glass-panel md:rounded-2xl md:shadow-2xl md:border md:border-nexus-gold/30">
            {/* HEADER */}
